...
def lookup(name : str) -> str:
    ...
    tools_for_agent = [
        Tool(
        name="search travily linkedin profile page",
    ...
    res = agent_executer.invoke({"input": prompt_template.format_prompt(name_of_person=name)})

    linked_profile_url = res["output"]
